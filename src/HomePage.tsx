...
export default function HomePage() {
  // rows live at top-level so child sections can use them
  ...
  return (
    <div className="font-inter min-h-screen flex flex-col bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden min-h-[100svh] flex items-center">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-rose-900 via-amber-800 to-stone-900" />
        {/* scrim for text legibility */}
        <div className="absolute inset-y-0 left-0 w-1/2 -z-0 bg-gradient-to-r from-black/60 via-black/40 to-transparent" />
        {/* soft blobs */}
        <div className="absolute -left-32 -top-32 w-[560px] h-[560px] rounded-full bg-gradient-to-tr from-amber-400/30 to-rose-400/20 blur-3xl" />
        <div className="absolute -right-24 -bottom-24 w-[520px] h-[520px] rounded-full bg-gradient-to-tr from-amber-400/30 to-rose-400/20 blur-3xl" />
        ...
        <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-14 items-center">
          <div className="text-white">
            <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.05] tracking-tight">
              ...
              <span className="bg-gradient-to-r from-amber-200 to-rose-100 bg-clip-text text-transparent">clarity.</span>
            </h1>
            <p className="mt-5 text-lg md:text-xl text-amber-100/90 max-w-xl">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-amber-100/90">
          ...
          {/* Hero chart card with shimmer */}
          <div className="">
            <div className="relative rounded-3xl border border-white/10 bg-white/10 backdrop-blur p-5 shadow-[0_10px_50px_rgba(0,0,0,0.35)] ring-1 ring-white/10">
              <div className="text-white/80 text-sm mb-2">Revenue over time</div>
              <div className="relative h-56 rounded-2xl bg-white/15 overflow-hidden">
                ...
                {/* shimmer overlay */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent animate-[shimmer_2.6s_linear_infinite]" />
              </div>
