...
function InsightsSection({ rows, gated }:{ rows: Row[]; gated:boolean }){
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#0B0D12] via-[#0E1117] to-black text-white">
  <div className="absolute inset-0 pointer-events-none">
    <div className="absolute -top-28 -right-24 h-96 w-96 rounded-full blur-3xl opacity-20 bg-brand-gold"></div>
    <div className="absolute -bottom-20 -left-16 h-72 w-72 rounded-full blur-3xl opacity-10 bg-brand-gold"></div>
  </div>
  <div className="container py-28">
    <div className="max-w-3xl">
      <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-wide">
        <span className="h-1.5 w-1.5 rounded-full bg-brand-gold"></span> Decks • Dashboards • AI
      </span>
      <h1 className="mt-6 font-display text-4xl md:text-6xl font-semibold leading-[1.1]">
        Make your data <span className="text-brand-gold">impossible to ignore</span>.
      </h1>
      <p className="mt-5 text-white/80 text-lg">
        Chartura turns messy spreadsheets into investor-ready slides, live executive dashboards,
        and plain‑English answers — in minutes.
      </p>
      <div className="mt-8 flex flex-wrap gap-3">
        <button className="btn btn-primary" onClick={()=>setGated(true)}>Start free trial</button>
        <a href="#interactive-demo" className="btn btn-ghost">See interactive demo</a>
      </div>
      <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-white/60">
        <div className="flex items-center gap-2"><span aria-hidden>✔</span> No credit card</div>
        <div className="flex items-center gap-2"><span aria-hidden>✔</span> PowerPoint & PDF export</div>
        <div className="flex items-center gap-2"><span aria-hidden>✔</span> Works with Excel/CSV/Sheets</div>
      </div>
    </div>
  </div>
</section>
...
function HowItWorks({ onTry, color }: { onTry: () => void; color:string }){
  const steps = [
    { title:'Upload your data', desc:'Drag Excel/CSV or paste a table. No prep needed.', icon:'📥' },
    { title:'Choose the story', desc:'Growth, retention, revenue — pick the view that matters.', icon:'🧭' },
    { title:'See premium visuals', desc:'On-brand charts and KPIs, instantly.', icon:'🎨' },
    { title:'Ask anything', desc:'Plain‑English Q&A with saved insights.', icon:'🤖' },
    { title:'Export & share', desc:'Stakeholder‑ready slides and dashboards in one click.', icon:'🚀' },
  ];
  return (
  ...
  <div className="container py-16">
    <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">What you get</h2>
    <p className="text-gray-600 mt-2">Everything you need to present with confidence.</p>
    <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className="card p-6">
        <div className="text-xl font-semibold mb-2">Investor‑ready slides</div>
        <p className="text-gray-600 text-sm leading-6">Auto‑designed decks in your brand with speaker notes and talking points.</p>
      </div>
      <div className="card p-6">
        <div className="text-xl font-semibold mb-2">Executive dashboards</div>
        <p className="text-gray-600 text-sm leading-6">Live KPIs, filters and drill‑downs so leaders see signal not noise.</p>
      </div>
      <div className="card p-6">
        <div className="text-xl font-semibold mb-2">Askura Q&A</div>
        <p className="text-gray-600 text-sm leading-6">Ask in plain English. Save answers as slides or share with your team.</p>
      </div>
      <div className="card p-6">
        <div className="text-xl font-semibold mb-2">One‑click exports</div>
        <p className="text-gray-600 text-sm leading-6">Export to PowerPoint, PDF and PNG in one click.</p>
      </div>
      <div className="card p-6">
        <div className="text-xl font-semibold mb-2">Brand consistency</div>
        <p className="text-gray-600 text-sm leading-6">Your logo, colors and typography applied automatically.</p>
      </div>
      <div className="card p-6">
        <div className="text-xl font-semibold mb-2">Security by design</div>
        <p className="text-gray-600 text-sm leading-6">Data stays encrypted; usage analytics only — never raw content.</p>
      </div>
    </div>
  </div>
</section>
...
export default function HomePage(){
  ...
  return (
    <div className="font-inter min-h-screen">
      ...
      <section id="interactive-demo" className="px-6 md:px-24 py-16 bg-gray-50">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-extrabold">Interactive demo</h2>
